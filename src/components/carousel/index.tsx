import React, {
	PropsWithChildren, ReactElement, useState, TouchEvent,
...
export function Carousel(props: PropsWithChildren<CarouselProps>) {
	const { defaultIndex, height, autoplayDelay, touchDiff, delay,
		viewportBoxshadow, children, autoplay, autoplayReverse, animationDelay, radioAppear, ...rest } = props;
